...
import com.nl.pm.server.registry.dao.LogDao;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

@Component
public class OperationLogImpl implements IOperationLogRegistry {

    @Autowired
    private LogDao logDao;

    @Override
    public void writeToDataBase(OperationLogEntity log) {
